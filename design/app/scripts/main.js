var drawMap = function(mapData, data, zones, htmlID) {
    ...
    var total = numeral(_.sumBy(data, 'value')).format();
    totalUberPickups.html(total);
...
var dataViz = function(errors, mapData, fhvBases, zones, uber1, uber2, uber3, uber4, uber5, uber6) {
